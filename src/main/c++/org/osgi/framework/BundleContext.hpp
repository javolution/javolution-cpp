 ...
 * @version 1.0
 */
class org::osgi::framework::BundleContext_API : public virtual java::lang::Object_API {
public:
     ...
     *         the service.
     */
    virtual ServiceRegistration registerService(java::lang::String const& className,
            java::lang::Object const& service, java::util::Dictionary const& properties) = 0;
     ...
     */
    virtual void addServiceListener(ServiceListener const& serviceListener, java::lang::String const& filter) = 0;
     ...
     */
    virtual Type::Array<ServiceReference> getServiceReferences(java::lang::String const& clazz, java::lang::String const& filterExpression) const = 0;
     ...
     */
    virtual java::lang::Object getService(ServiceReference const& reference) = 0;
     ...
     */
    virtual Filter createFilter(java::lang::String const& filter) const = 0;
