 ...
 * All rights reserved.
 */
#ifndef _JAVA_LANG_ARITHMETIC_EXCEPTION_HPP
#define _JAVA_LANG_ARITHMETIC_EXCEPTION_HPP
 ...
 * @version 1.0
 */
class java::lang::ArithmeticException_API : public java::lang::RuntimeException_API {
protected:
