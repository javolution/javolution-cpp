 ...
 * All rights reserved.
 */
#ifndef _JAVA_LANG_STRING_HPP
#define _JAVA_LANG_STRING_HPP
 ...
 *       Java - String</a>
 */
class java::lang::String_API : public virtual java::lang::Object_API {
...
public:
     ...
     */
    JAVOLUTION_DLL static String valueOf(java::lang::Integer32 const& i32);

    /**
     * Equivalent to <code>valueOf(i64->longValue())</code>
     */
    JAVOLUTION_DLL static String valueOf(java::lang::Integer64 const& i64);

    /**
     * Equivalent to <code>valueOf(f32->floatValue())</code>
     */
    JAVOLUTION_DLL static String valueOf(java::lang::Float32 const& f32);

    /**
     * Equivalent to <code>append(f64->doubleValue())</code>
     */
    JAVOLUTION_DLL static String valueOf(java::lang::Float64 const& f64);
...
class java::lang::String : public Type::Handle<java::lang::String_API> {
public:
...
inline java::lang::String java::lang::String_API::toString() const {
