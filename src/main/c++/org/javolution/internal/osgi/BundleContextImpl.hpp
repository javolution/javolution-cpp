 ...
 * All rights reserved.
 */
#ifndef _ORG_JAVOLUTION_INTERNAL_OSGI_BUNDLE_CONTEXT_IMPL_HPP
#define _ORG_JAVOLUTION_INTERNAL_OSGI_BUNDLE_CONTEXT_IMPL_HPP
...
#include "org/javolution/internal/osgi/ServiceRegistrationImpl.hpp"
#include "org/javolution/internal/osgi/FilterImpl.hpp"
 ...
 * @version 1.0
 */
class org::javolution::internal::osgi::BundleContextImpl_API : public virtual BundleContext_API {
public: // Internal classes can have public members visibility.
    ...
    Filter createFilter(java::lang::String const& filter) const {
    ...
    ServiceReference getServiceReference(java::lang::String const& clazz) const {
        try {
            Type::Array<ServiceReference> refs = getServiceReferences(clazz, Type::Null);
            return (refs == Type::Null) ? Type::Null : refs[0];
        } catch (InvalidSyntaxException e) {
            Logging_API::error(L"ORG_JAVOLUTION", L"Invalid Syntax", e);
        }
        return Type::Null;
    }
};
