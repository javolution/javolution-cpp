...
#ifndef _ORG_JAVOLUTION_UTIL_ABSTRACT_COLLECTION_HPP
#define _ORG_JAVOLUTION_UTIL_ABSTRACT_COLLECTION_HPP
...
namespace org { namespace javolution { namespace util {
        ...
        template<class E>class java::util::List_API; // Forwards reference.
        ...
        public:
            AbstractCollection(Type::NullHandle = Type::Null) : Type::Handle<AbstractCollection_API<E> >() {} // Null
 ...
 */
template<class E>
class org::javolution::util::AbstractCollection_API : public virtual java::util::Collection_API<E> {
protected:
...
public:
    ...
    // Overrides.
    virtual void clear() {
        java::util::Iterator<E> i = this->iterator();
        while (i->hasNext()) {
            i->next();
            i->remove();
        }
    ...
    virtual Type::Array<java::lang::Object> toArray() const {
        ...
        Type::Array<java::lang::Object> result = Type::Array<java::lang::Object> (n);
        java::util::Iterator<E> i = this->iterator();
        Type::int32 j = 0;
        while (i->hasNext()) {
            result[j++] = i->next();
    ...
    virtual Type::Array<E> toArray(Type::Array<E> const& result) const {
        if (result.length != this->size())
            throw java::lang::UnsupportedOperationException_API::newInstance(
    ...
    virtual Type::boolean equals(java::lang::Object const& obj) const {
    	java::util::Collection<E> that = Type::dynamic_handle_cast<java::util::Collection_API<E> >(obj);
        if (that == Type::Null) return false;
        if (this->size() != that->size()) return false;
        Type::boolean thisIsList = dynamic_cast<const java::util::List_API<E>* >(this) != 0;
        Type::boolean thatIsList = Type::dynamic_handle_cast<java::util::List_API<E> >(that) != 0;
        if (thisIsList && thatIsList) { // They should have the same order.
            java::util::Iterator<E> i = this->iterator();
            java::util::Iterator<E> j = that->iterator();
            while (i->hasNext()) {
            ...
            return containsAll(java::util::Collection<E>(that)); // We know they have same size.
    ...
    virtual Type::int32 hashCode() const {
        Type::boolean isList = dynamic_cast<const java::util::List_API<E>* > (this) != 0;
        java::util::Iterator<E> i = this->iterator();
        int h = 1;
        while (i->hasNext()) {
            if (isList) {
...
private:
    ...
    static Type::int32 hash(E const& e) {
        java::lang::Object_API* obj = e.get();
