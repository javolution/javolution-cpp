 ...
 * All rights reserved.
 */
#ifndef _ORG_JAVOLUTION_TIME_TIME_UTC_HPP
#define _ORG_JAVOLUTION_TIME_TIME_UTC_HPP
...
namespace org { namespace javolution { namespace time {
        class TimeUTC_API;
 ...
 * @version 1.0
 */
class org::javolution::time::TimeUTC_API : public virtual java::lang::Object_API {
...
public:
    ...
    // Overrides.
    JAVOLUTION_DLL java::lang::String toString() const;

    // Overrides
    Type::boolean equals(java::lang::Object obj) const {
