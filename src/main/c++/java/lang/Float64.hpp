 ...
 * All rights reserved.
 */
#ifndef _JAVA_LANG_FLOAT64_HPP
#define _JAVA_LANG_FLOAT64_HPP
 ...
 * @version 1.0
 */
class java::lang::Float64_API : public java::lang::Number_API {
...
class java::lang::Float64 : public Type::Handle<java::lang::Float64_API> {
public:
...
inline java::lang::Float64 java::lang::Float64_API::valueOf(Type::float64 thisValue) {
...
inline Type::boolean  java::lang::Float64_API::equals(java::lang::Object const& obj) const {
    Float64 that = Type::dynamic_handle_cast<Float64_API>(obj);
    if (that == Type::Null) return false;
    return equals(that);
}
inline Type::boolean  java::lang::Float64_API::equals( java::lang::Float64 const& that) const {
