 ...
 * All rights reserved.
 */
#ifndef _JAVA_UTIL_CONCURRENT_EXECUTOR_SERVICE_HPP
#define _JAVA_UTIL_CONCURRENT_EXECUTOR_SERVICE_HPP
 ...
 * @version 1.6
 */
class java::util::concurrent::ExecutorService_API : public virtual java::util::concurrent::Executor_API {
public:
     ...
     */
    virtual java::util::List<java::lang::Runnable> shutdownNow() = 0;
     ...
     */
    virtual Type::boolean awaitTermination(Type::int64 timeout, java::util::concurrent::TimeUnit const& unit) const = 0;
