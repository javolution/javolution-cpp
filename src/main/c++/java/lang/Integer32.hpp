 ...
 * All rights reserved.
 */
#ifndef _JAVA_LANG_INTEGER32_HPP
#define _JAVA_LANG_INTEGER32_HPP
 ...
 * @version 1.0
 */
class java::lang::Integer32_API : public java::lang::Number_API {
...
class java::lang::Integer32 : public Type::Handle<java::lang::Integer32_API> {
public:
...
inline java::lang::Integer32 java::lang::Integer32_API::valueOf(Type::int32 value) {
...
inline Type::boolean java::lang::Integer32_API::equals(java::lang::Object const& obj) const {
    Integer32 that = Type::dynamic_handle_cast<Integer32_API>(obj);
    if (that == Type::Null) return false;
    return equals(that);
}
inline Type::boolean java::lang::Integer32_API::equals(java::lang::Integer32 const& that) const {
