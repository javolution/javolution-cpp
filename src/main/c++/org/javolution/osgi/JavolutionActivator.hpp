 ...
 * All rights reserved.
 */
#ifndef _ORG_JAVOLUTION_OSGI_JAVOLUTION_ACTIVATOR_HPP
#define _ORG_JAVOLUTION_OSGI_JAVOLUTION_ACTIVATOR_HPP
...
#define JAVOLUTION_MAJOR_VERSION "7.0"
 ...
 * @version 1.3
 */
class org::javolution::osgi::JavolutionActivator_API : public virtual org::osgi::framework::BundleActivator_API {
public:
...
private:
    ...
    JAVOLUTION_DLL static void checkVersion(java::lang::String const& majorVersion, char* ident);
