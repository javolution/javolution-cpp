 ...
 * All rights reserved.
 */
#ifndef _JAVA_UTIL_LIST_HPP
#define _JAVA_UTIL_LIST_HPP
 ...
 * @version 1.0
 */
template <class E> class java::util::List_API : public virtual java::util::Collection_API<E> {
public:

    // Methods from Collection hidden by current methods should be 'unhidden' 
    using java::util::Collection_API<E>::add; // add(E) hidden.
    using java::util::Collection_API<E>::addAll; // addAll(Collection) hidden.
    using java::util::Collection_API<E>::remove; // remove(E) hidden.
     ...
     */
    virtual Type::boolean addAll(Type::int32 index, java::util::Collection<E> const& c) = 0;
     ...
     */
     virtual Type::int32 indexOf(java::lang::Object const& o) const = 0;

    /**
     * Returns the index in this list of the last occurrence of the specified element,
     * or <code>-1</code> if this list does not contain this element.
     */
     virtual Type::int32 lastIndexOf(java::lang::Object const& o) const = 0;

     /**
      *  Returns a view of the portion of this list between the specified fromIndex,
      * inclusive, and toIndex, exclusive.
      */
     virtual java::util::List<E> subList(Type::int32 fromIndex, Type::int32 toIndex) const = 0;
