 ...
 * All rights reserved.
 */
#ifndef _JAVA_UTIL_CONCURRENT_TIME_UNIT_HPP
#define _JAVA_UTIL_CONCURRENT_TIME_UNIT_HPP
...
namespace java {
    namespace util {
        namespace concurrent {
            class TimeUnit_API;
            typedef java::lang::Enum<TimeUnit_API> TimeUnit;
        }
    }
}
 ...
 * @version 1.6
 */
class java::util::concurrent::TimeUnit_API : public java::lang::Enum_API<java::util::concurrent::TimeUnit_API> {
...
public:
     ...
     */
    JAVOLUTION_DLL Type::int64 convert(Type::int64 sourceDuration, java::util::concurrent::TimeUnit const& sourceUnit) const;
     ...
     */
     JAVOLUTION_DLL void timedWait(java::lang::Object const& obj, Type::int64 timeout) const;
     ...
     * or equal to zero, do not wait at all.
     */
    JAVOLUTION_DLL void timedJoin(java::lang::Thread const& thread, Type::int64 timeout) const;
