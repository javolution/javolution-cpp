 ...
 * All rights reserved.
 */
#ifndef _ORG_JAVOLUTION_INTERNAL_OSGI_BUNDLE_IMPL_HPP
#define _ORG_JAVOLUTION_INTERNAL_OSGI_BUNDLE_IMPL_HPP
 ...
 * @version 1.0
 */
class org::javolution::internal::osgi::BundleImpl_API : public virtual Bundle_API {
