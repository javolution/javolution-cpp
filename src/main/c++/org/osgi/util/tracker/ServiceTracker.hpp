...
class org::osgi::util::tracker::ServiceTracker_API : public virtual org::osgi::util::tracker::ServiceTrackerCustomizer_API {
     ...
     */
    org::javolution::util::FastMap<org::osgi::framework::ServiceReference, java::lang::Object> _trackedServices;
     ...
     */
    java::lang::Object _cachedService;
...
protected:
    ...
    ServiceTracker_API(org::osgi::framework::BundleContext const& context,
            java::lang::String const& serviceName, ServiceTrackerCustomizer const& customizer) {
        _context = context;
        ...
        java::lang::StringBuilder listenerFilter = java::lang::StringBuilder_API::newInstance();
        ...
        _trackedServices = new org::javolution::util::FastMap_API<org::osgi::framework::ServiceReference, java::lang::Object > ();
        _trackingCount = -1;
    }
...
public:
     ...
     */
    JAVOLUTION_DLL virtual java::lang::Object getService();
     ...
     */
    JAVOLUTION_DLL virtual java::lang::Object getService(org::osgi::framework::ServiceReference const& serviceReference);
     ...
     */
    JAVOLUTION_DLL virtual Type::Array<java::lang::Object> getServices();
     ...
     */
    virtual java::lang::Object addingService(org::osgi::framework::ServiceReference const& serviceReference) {
     ...
     * Implements ServiceTrackerCustomizer.
     */
    virtual void modifiedService(org::osgi::framework::ServiceReference const&, java::lang::Object const&) {
        // Do nothing.
    }
     ...
     * Implements ServiceTrackerCustomizer.
     */
    virtual void removedService(org::osgi::framework::ServiceReference const& serviceReference, java::lang::Object const&) {
