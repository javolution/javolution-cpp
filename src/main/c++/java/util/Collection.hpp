 ...
 * All rights reserved.
 */
#ifndef _JAVA_UTIL_COLLECTION_HPP
#define _JAVA_UTIL_COLLECTION_HPP

#include "java/lang/Object.hpp"
#include "java/lang/UnsupportedOperationException.hpp" // Raised by optional operations not supported.
 ...
 * @version 1.0
 */
template <class E> class java::util::Collection_API : public virtual java::lang::Object_API {
public:
     ...
     */
    virtual Type::boolean addAll(java::util::Collection<E> const& c) = 0;
     ...
     */
    virtual Type::boolean containsAll(java::util::Collection<E> const& c) const = 0;
     ...
     */
    virtual Type::boolean equals(java::lang::Object const& o) const = 0;
     ...
     */
    virtual java::util::Iterator<E> iterator() const = 0;
     ...
     */
    virtual Type::boolean removeAll(java::util::Collection<E> const& c) = 0;

    /**
     *  Retains only the elements in this collection that are contained in the
     *  specified collection (optional operation).
     */
    virtual Type::boolean retainAll(java::util::Collection<E> const& c) = 0;
     ...
     */
    virtual Type::Array<java::lang::Object> toArray() const = 0;
