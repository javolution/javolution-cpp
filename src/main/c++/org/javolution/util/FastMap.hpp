...
#ifndef _ORG_JAVOLUTION_UTIL_FAST_MAP_HPP
#define _ORG_JAVOLUTION_UTIL_FAST_MAP_HPP
...
class org::javolution::util::FastMap_API : public virtual java::util::Map_API<K, V> {
...
public:
     ...
     * (optional operation).
     */
    virtual void putAll(java::util::Map<K, V> const& m) {
        for (java::util::Iterator<java::util::Entry<K,V> > i = m->entrySet()->iterator(); i->hasNext();) {
        	java::util::Entry<K,V> entry = i->next();
     ...
     */
    virtual java::util::Set< java::util::Entry<K, V> > entrySet() const {
     ...
     * reflected in the set, and vice-versa.
     */
    virtual java::util::Set<K> keySet() const {
     ...
     */
    virtual java::util::Collection<V> values() const {
...
template<class K, class V>
class org::javolution::util::FastMapEntry_API : public virtual java::util::Entry_API<K,V> {
...
template<class K, class V>
class org::javolution::util::EntrySetIterator_API : public virtual java::util::Iterator_API<java::util::Entry<K,V> > {

     FastMap<K,V> map;
     Type::int32 capacity;
     Type::int32 currentIndex;
     Type::int32 nextIndex;
     java::util::Entry<K,V> currentEntry;
...
public:
    ...
    java::util::Entry<K,V> const& next() {
        if (nextIndex == capacity) throw java::util::NoSuchElementException_API::newInstance(L"Method Iterator.next()");
    ...
    void remove() {
        if (currentIndex == -1) throw java::lang::IllegalStateException_API::newInstance(L"No current key to remove");
...
template<class K, class V>
class org::javolution::util::KeySetIterator_API : public virtual java::util::Iterator_API<K> {
...
template<class K, class V>
class org::javolution::util::ValuesIterator_API : public virtual java::util::Iterator_API<V> {
...
template<class K, class V>
class org::javolution::util::EntrySet_API : public org::javolution::util::AbstractSet_API< java::util::Entry<K,V> > {
...
public:
	...
	java::util::Iterator< java::util::Entry<K,V> > iterator() const {
        return java::util::Iterator<java::util::Entry<K,V> > (new EntrySetIterator_API<K,V> (map));
    }
...
template<class K, class V>
class org::javolution::util::KeySet_API : public org::javolution::util::AbstractSet_API<K> {
...
public:
    ...
    java::util::Iterator<K> iterator() const {
        return java::util::Iterator<K> (new KeySetIterator_API<K,V> (map));
    }
...
template<class K, class V>
class org::javolution::util::Values_API : public org::javolution::util::AbstractCollection_API<V> {
...
public:
    ...
    java::util::Iterator<V> iterator() const {
        return java::util::Iterator<V> (new ValuesIterator_API<K,V> (map));
    }
