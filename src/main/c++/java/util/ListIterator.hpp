 ...
 * All rights reserved.
 */
#ifndef _JAVA_UTIL_LIST_ITERATOR_HPP
#define _JAVA_UTIL_LIST_ITERATOR_HPP
 ...
 * @version 1.0
 */
template <class E> class java::util::ListIterator_API : public virtual java::util::Iterator_API<E> {
public:
