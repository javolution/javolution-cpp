...
class junit::framework::TestSuite_API : public virtual junit::framework::Test_API {
     ...
     * Holds the tests.
     */
    org::javolution::util::FastTable<Test> _tests;
...
public:
     ...
     */
    TestSuite_API(java::lang::String const& name) {
        _name = name;
        _tests = new org::javolution::util::FastTable_API<Test>();
    };
     ...
     * @param name the name of the test suite.
     */
    static TestSuite newInstance(java::lang::String const& name) {
