...
#define BEGIN_SUITE(name)  \
    ...
    static junit::framework::TestSuite suite() { \
        junit::framework::TestSuite tests = new junit::framework::TestSuite_API( java::lang::String_API::valueOf(#name) );

#define ADD_TEST(testMethod)  \
        thisType* testMethod##TestCasePtr = new thisType(); \
        testMethod##TestCasePtr->name = java::lang::String_API::valueOf(#testMethod); \
...
protected:
    ...
    java::lang::String dummy; // For alignment purpose. TODO Try to remove.
...
public:
     ...
     */
    virtual java::lang::String const& getName() {
        return name;
    }
