 ...
 * All rights reserved.
 */
#ifndef _JAVA_LANG_FLOAT32_HPP
#define _JAVA_LANG_FLOAT32_HPP
 ...
 * @version 1.0
 */
class java::lang::Float32_API : public java::lang::Number_API {
...
public:
    ...
    Type::int32 intValue() const {
        if ((_value < -2147483328.0) || (_value > 2147483327.0))
            throw java::lang::ArithmeticException_API::newInstance("intValue() overflow");
    ...
    Type::int64 longValue() const {
        if ((_value < -9223372036854775808.0) || (_value > 9223372036854775807.0))
            throw java::lang::ArithmeticException_API::newInstance("longValue() overflow");
    ...
    java::lang::String toString() const {
        return java::lang::String_API::valueOf(_value);
    }
...
class java::lang::Float32 : public Type::Handle<java::lang::Float32_API> {
public:
...
inline java::lang::Float32 java::lang::Float32_API::valueOf(Type::float32 thisValue) {
...
inline Type::boolean java::lang::Float32_API::equals(java::lang::Object const& obj) const {
    Float32 that = Type::dynamic_handle_cast<Float32_API>(obj);
    if (that == Type::Null) return false;
    return equals(that);
}
inline Type::boolean java::lang::Float32_API::equals(java::lang::Float32 const& that) const {
