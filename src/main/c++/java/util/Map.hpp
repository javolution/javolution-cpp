 ...
 * All rights reserved.
 */
#ifndef _JAVA_UTIL_MAP_HPP
#define _JAVA_UTIL_MAP_HPP
...
namespace java {
    namespace util {
        ...
        class Entry_API; // TODO Move to Map namespace.
 ...
 * @version 1.0
 */
template <class K, class V> class java::util::Map_API : public virtual java::lang::Object_API {
public:
     ...
     * (optional operation).
     */
    virtual void putAll(java::util::Map<K, V> const& m) = 0;
 ...
 */
template <class K, class V> class java::util::Entry_API : public virtual java::lang::Object_API {
public:
    /**
