 ...
 * All rights reserved.
 */
#ifndef _JAVA_LANG_ENUM_HPP
#define _JAVA_LANG_ENUM_HPP
 ...
 * class Color_API;
 * typedef java::lang::Enum<Color_API> Color; // Public shortcut.
 * class Color_API : public java::lang::Enum_API<Color_API> {
 * public:
 ...
 * @version 1.0
 */
 class java::lang::Enum_ANY_API : public virtual java::lang::Object_API {
...
template <class E> class java::lang::Enum_API : public Enum_ANY_API  {
...
template<class T>
class java::lang::Enum : public java::lang::Enum_ANY  {
public:
