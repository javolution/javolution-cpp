...
namespace org {
    namespace osgi {
        namespace framework {
            ...
            class InvalidSyntaxException : public java::lang::Exception {
            public:
 ...
 * @version 1.0
 */
class org::osgi::framework::InvalidSyntaxException_API : public virtual java::lang::Exception_API {
protected:

    InvalidSyntaxException_API(java::lang::String const& message) :
        java::lang::Exception_API(message) {
    };
