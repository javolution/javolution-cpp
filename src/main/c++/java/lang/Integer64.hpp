 ...
 * All rights reserved.
 */
#ifndef _JAVA_LANG_INTEGER64_HPP
#define _JAVA_LANG_INTEGER64_HPP
 ...
 * @version 1.0
 */
class java::lang::Integer64_API : public java::lang::Number_API {
...
class java::lang::Integer64 : public Type::Handle<java::lang::Integer64_API> {
public:
...
inline java::lang::Integer64 java::lang::Integer64_API::valueOf(Type::int64 value) {
...
// Overrides
inline Type::boolean java::lang::Integer64_API::equals(java::lang::Object const& obj) const {
    Integer64 that = Type::dynamic_handle_cast<Integer64_API>(obj);
    if (that == Type::Null) return false;
    return equals(that);
}
inline Type::boolean java::lang::Integer64_API::equals(java::lang::Integer64 const& that) const {
