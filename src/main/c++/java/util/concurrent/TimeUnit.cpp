...
const Class<TimeUnit_API> TIME_UNIT_CLASS = Class_API<TimeUnit_API>::forName(L"java::util::concurrent::TimeUnit_API");
...
Type::int64 TimeUnit_API::convert(Type::int64 , java::util::concurrent::TimeUnit const&) const {
...
void TimeUnit_API::timedWait(java::lang::Object const&, Type::int64) const {
    throw UnsupportedOperationException_API::newInstance(L"Not implemented yet");
}
void TimeUnit_API::timedJoin(java::lang::Thread const&, Type::int64) const {
    throw UnsupportedOperationException_API::newInstance(L"Not implemented yet");
}
