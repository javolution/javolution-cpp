 ...
 * @version 1.0
 */
class org::osgi::util::tracker::ServiceTrackerCustomizer_API : public virtual java::lang::Object_API {
public:
     ...
     */
    virtual java::lang::Object addingService(org::osgi::framework::ServiceReference const& serviceReference) = 0;
     ...
     */
    virtual void modifiedService(org::osgi::framework::ServiceReference const& reference, java::lang::Object const& service) = 0;
     ...
     * @param service The service object for the specified referenced service.
     */
    virtual void removedService(org::osgi::framework::ServiceReference const& serviceReference, java::lang::Object const& service) = 0;
