 ...
 * All rights reserved.
 */
#ifndef _JAVA_UTIL_CONCURRENT_EXECUTORS_HPP
#define _JAVA_UTIL_CONCURRENT_EXECUTORS_HPP
 ...
 * @version 1.6
 */
class java::util::concurrent::Executors_API : public virtual java::lang::Object_API {
...
public:
     ...
     */
    JAVOLUTION_DLL static java::util::concurrent::ExecutorService newFixedThreadPool(Type::int32 nThreads);
     ...
     */
    JAVOLUTION_DLL static java::util::concurrent::ExecutorService newSingleThreadExecutor();
     ...
     * @return the newly created thread pool
     */
    JAVOLUTION_DLL static java::util::concurrent::ExecutorService newCachedThreadPool();
