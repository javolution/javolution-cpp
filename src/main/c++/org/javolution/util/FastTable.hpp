...
#ifndef _ORG_JAVOLUTION_UTIL_FAST_TABLE_HPP
#define _ORG_JAVOLUTION_UTIL_FAST_TABLE_HPP
...
#include "org/javolution/util/AbstractList.hpp"
 ...
 */
template<class E>
class org::javolution::util::FastTable_API : public org::javolution::util::AbstractList_API<E> {
...
public:
    ...
    using org::javolution::util::AbstractList_API<E>::addAll; // addAll(Collection) hidden.
    using org::javolution::util::AbstractList_API<E>::remove; // remove(E) hidden.

    /**
     * Returns a new empty instance of this class.
     */
    static FastTable<E> newTable() {
     ...
     */
    virtual Type::boolean addAll(Type::int32 index, java::util::Collection<E> const& c) {
        if ((index < 0) || (index > count))
            throwIndexOutOfBoundsException(index);
        Type::int32 shift = c->size();
        shiftRight(index, shift);
        java::util::Iterator <E> cIterator = c->iterator();
     ...
     * The iterator returned should not outlive the list it iterates over.
     */
    virtual java::util::ListIterator<E> listIterator() const {
     ...
     * The iterator returned should not outlive the list it iterates over.
     */
    virtual java::util::ListIterator<E> listIterator(Type::int32 index) const {
     ...
     */
    virtual Type::int32 indexOf(java::lang::Object const& o) const {
        if (o == Type::Null) {
     ...
     * or <code>-1</code> if this list does not contain this element.
     */
    virtual Type::int32 lastIndexOf(java::lang::Object const& o) const {
        if (o == Type::Null) {
     ...
     */
    virtual java::util::List<E> subList(Type::int32 fromIndex, Type::int32 toIndex) const {
...
private:
    ...
    void resize() {
        ...
        java::lang::System_API::arraycopy(elements, 0, newElements, 0, elements.length);
    ...
    void throwIndexOutOfBoundsException(Type::int32 index) const {
        throw java::lang::IndexOutOfBoundsException_API::newInstance(
                java::lang::StringBuilder_API::newInstance()
                ->append(L"Index: ")
                ->append(index)
                ->append(L", List size: ")
...
template<class E>
class org::javolution::util::FastTableIterator_API : public virtual java::util::ListIterator_API<E> {
...
public:
    ...
    E const& next() {
        if (nIndex == end) throw java::util::NoSuchElementException_API::newInstance(L"iterator->next()");
    ...
    E const& previous() {
        if (nIndex == start) throw java::util::NoSuchElementException_API::newInstance(L"iterator->previous()");
        Type::int32 i = currentIndex = --nIndex;
        return list->elements[i];
    }
    ...
    void set(E const& o) {
        if (currentIndex < 0)
            throw java::lang::IllegalStateException_API::newInstance(L"iterator->set(E)");
        list->set(currentIndex, o);
    }

    void remove() {
        if (currentIndex < 0) throw java::lang::IllegalStateException_API::newInstance(L"iterator->remove()");
...
template<class E>
class org::javolution::util::ArraySubList_API : public org::javolution::util::AbstractList_API<E> {
    FastTable<E> source;
    Type::int32 offset;
    Type::int32 count;
...
public:
    ...
    using java::util::Collection_API<E>::addAll;

    /////////////////////////
    // Collection  methods //
    /////////////////////////

    java::util::Iterator<E> iterator() const {
        return listIterator();
    }
    ...
    Type::int32 indexOf(java::lang::Object const& o) const {
        if (o == Type::Null) {
            for (Type::int32 i = 0; i < count; i++) {
                if (get(i) == Type::Null)
                    return i;
    ...
    Type::int32 lastIndexOf(java::lang::Object const& o) const {
        if (o == Type::Null) {
            for (Type::int32 i = count - 1; i >= 0; i--) {
                if (get(i) == Type::Null)
                    return i;
    ...
    java::util::ListIterator<E> listIterator() const {
        return listIterator(0);
    }

    java::util::ListIterator<E> listIterator(Type::int32 index) const {
        return new FastTableIterator_API<E > (source, offset + index, offset + count);
    }

    java::util::List<E> subList(Type::int32 fromIndex, Type::int32 toIndex) const {
    ...
    Type::boolean addAll(Type::int32, java::util::Collection<E> const&) {
        throwUnsupportedOperationException();
        return false;
    }
...
private:
    ...
    void throwUnsupportedOperationException() const {
        if (this) throw java::lang::UnsupportedOperationException_API::newInstance(
