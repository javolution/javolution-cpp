 ...
 * @version 1.0
 */
class org::osgi::framework::Bundle_API : public virtual java::lang::Object_API {
public:
     ...
     */
    virtual java::lang::String getSymbolicName() const = 0;
     ...
     */
    virtual java::util::Dictionary getHeaders() const = 0;
